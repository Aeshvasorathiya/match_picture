...
import 'package:match_picture/match1.dart';
...
class _gameState extends State<game> {
  ...
  get() async {
    ...
    first.prefs!.setInt("sec",a1 as int);
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: (a != 0)
            ? Text("TIME : $a/0", style: TextStyle(fontSize: 20))
            : Text("TIME : $a1/0", style: TextStyle(fontSize: 20)),
                                  ...
                                  if (!temp[index] && x == 2) {
                                    ...
                                    if (pic1[pos1] == pic1[pos2]) {
                                      ...
                                      if (temp[0] == true &&
                                          ...
                                          temp[10] == true &&
                                          temp[11] == true) {
                                        int temp_sec = first.prefs!.getInt(
                                                "level_time${level_no}") ??
                                            0;
                                        if (a1 < temp_sec) {
                                          first.prefs!.setInt(
